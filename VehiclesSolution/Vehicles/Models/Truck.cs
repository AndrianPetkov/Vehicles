...
namespace Vehicles.Models
{
    public class Truck : Vehicle
    {
        ...
        public Truck(double fuelQuantity, double fuelConsumption, double tankCapacity, bool hasAirConditioner = true) : base(fuelQuantity, fuelConsumption, tankCapacity, hasAirConditioner)
        {
        }
        ...
        public override void Refuel(double liters)
        {
            ...
            {
                string msg = string.Format(ExceptionMessages.InvalidStringAmount, liters);
