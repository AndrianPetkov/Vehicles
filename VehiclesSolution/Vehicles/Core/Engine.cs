...
namespace Vehicles.Core
{
    public class Engine : IEngine
    {
        ...
        private void RefuelCommand(string vehicleType, IVehicle car, IVehicle truck, IVehicle bus,
            double arg)
        {
        ...
        private void DriveCommand(string vehicleType, IVehicle car, IVehicle truck, IVehicle bus,
            double arg)
        {
            bool isDrive = false;
